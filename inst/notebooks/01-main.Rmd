...
There are `r dim(stormdata.raw)[1]` observations and `r dim(stormdata.raw)[2]` variables.
...
REFNUM, BGN_DATE, STATE, COUNTY, COUNTYNAME, EVTYPE, FATALITIES, INJURIES, PROPDMG, PROPDMGEXP, CROPDMG, CROPDMGEXP, REMARKS
```{r}
